...
def body(circuit, settings):
    ...
    for inst in circuit:
        ...
        # If this is a many-qubit operation.
            ...
            possible_lines = range(min(explicit_lines), max(explicit_lines) + 1)
            ...
            for line in possible_lines:
                if line in qubit_instruction_mapping.keys():
    ...
    def to_tikz(self, line, circuit, end=None):
        ...
        for i in range(0, end):
            ...
            if gate == X:
                ...
                add_str = self._regular_gate(gate, lines, ctrl_lines, cmds[i].used_lines)
                for l in lines:
